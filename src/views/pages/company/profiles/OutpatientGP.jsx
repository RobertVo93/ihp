...
class CompanyOutpatientGPProfile extends Component {
                ...
                <div className="plr-15">
                    ...
                    <div className="mtb-30 theme-color">
                        <div className="introduction">
                            Company Outpatient GP Profile Dashboard [{this.props.companyData.companyID}]
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            <CompanyProfileDashboard statMode="Outpatient GP"
                            />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            <CompanyProfileDemographicsSpending statMode="Outpatient GP"
                            />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-6">
                            <CompanyProfileTopRelations statMode="Outpatient GP"
                            />
                        </div>
                        <div className="col-lg-6">
                            <CompanyProfileClassifications statMode="Outpatient GP"
                            />
                        </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <CompanyProfileTopDiagnosis statMode="Outpatient GP"
                            />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            <CompanyProfileTopProviders statMode="Outpatient GP"
                            />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            <CompanyProfileTopEmployees statMode="Outpatient GP"
                            />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            <CompanyProfileClaimOverMonths statMode="Outpatient GP"
                            />
                        </div>
                    </div>
...
export default connect(mapStateToProps, null)(CompanyOutpatientGPProfile);
