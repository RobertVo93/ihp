...
const CompanyOverviewTopSpendingTable = props => {
			...
			<div className="roe-card-style mt-15 mb-30">
                ...
                <div className="row header-container">
                    <div className="float-left">
                        <p className="card-main-header">Top Employee Spending (Table)</p>
...
export default connect(mapStateToProps, {})(CompanyOverviewTopSpendingTable);
