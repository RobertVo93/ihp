...
const CompanyGLStatisticsBreakdownByType = props => {
	...
	return (
            ...
            <div className="roe-card-header">
                <div className="row header-container">
                    <div className="float-left">
                        <p className="card-main-header">{props.status} GL types breakdown</p>
        ...
        <div className="col-lg-6">
            <StatisticsBreakdownTable status={props.status} tData={tData} />
        </div>
    </div>
	);
};
...
export default connect(mapStateToProps, { getCompanyGLBreakdown })(
	CompanyGLStatisticsBreakdownByType
);
