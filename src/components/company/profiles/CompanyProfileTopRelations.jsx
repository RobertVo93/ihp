...
const { getCompanyInpatientProfileRelations, getCompanyOutpatientProfileRelations } = CompActions;

const CompanyProfileTopRelations = props => {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            if (props.statMode == "Inpatient") {
                await props.getCompanyInpatientProfileRelations(props.authData, props.companyData.companyID);
            } else if (props.statMode == "Outpatient GP") {
                await props.getCompanyOutpatientProfileRelations(props.authData, props.companyData.companyID, "GP");
            } else if (props.statMode == "Outpatient SP") {
                await props.getCompanyOutpatientProfileRelations(props.authData, props.companyData.companyID, "SP");
            }
    ...
    useEffect(() => {
        setIncData(props.companyData.relationsData);
    }, [props.companyData.relationsData]);
    ...
    useEffect(() => {
        ...
        for (var i = 0; i < incomingData.length; i++) {
            if (i <= 8) {
                labels.push(incomingData[i].Relation);
            ...
            <div className="roe-card-header">
                <div className="row header-container">
                    <div className="float-left">
                        <p className="card-main-header">Relations Expenditure Breakdown</p>
...
const mapStateToProps = state => {
    return {
        ...
        companyData: {
            ...
            relationsData: state.company.companyProfileRelations,
        }
    };
};
...
export default connect(
    mapStateToProps,
    { getCompanyInpatientProfileRelations, getCompanyOutpatientProfileRelations }
)(CompanyProfileTopRelations);