...
const { getVisitsByMonths } = PatActions;

const PatientOverviewVisitsByMonths = props => {
  //call apis
  ...
  useEffect(() => {
    setIncData(props.patientData.visitsByMonths);
  }, [props.patientData.visitsByMonths]);
...
const mapStateToProps = state => {
  return {
    ...
    patientData: {
      ...
      visitsByMonths: state.patient.patientVisitsByMonths
    }
  };
};
