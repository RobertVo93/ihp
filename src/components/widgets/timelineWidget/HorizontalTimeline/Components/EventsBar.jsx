 ...
 */
const EventsBar = ({ events, selectedIndex, styles, handleDateClick, handleDateHover, labelWidth, dotComponent: DotComponent }) => (
	<EventsBarContainer
...
EventsBar.propTypes = {
	...
	// a handler for mouse hover on a datapoint
